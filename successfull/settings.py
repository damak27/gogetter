"""
Django settings for successfull project.
...
SECRET_KEY = 'jd4y^w(&+d=b0kkk_bj71xt*pj*n3lmwzdfz084y6%pe9@vkph'
...
AUTH_PROFILE_MODULE ='success.UserProfile'
...
WSGI_APPLICATION = 'successfull.wsgi.application'
